...
public class VehicleModelResources implements RenderTargetResources {
    ...
    public VehicleModelResources(GeoModel model, AnimationStore animations, Object2ReferenceMap<String, AnimationControllerData> controllers, AbstractTexture texture, CommonAsset assets) {
        this.model = model;
