...
public final class RenderUtils {
    public static void translateMatrixToBone(PoseStack poseStack, BoneView bone) {
        // TODO
//        poseStack.translate(-bone.getPositionX() / 16f, bone.getPositionY() / 16f, bone.getPositionZ() / 16f);
    }

    public static void rotateMatrixAroundBone(PoseStack poseStack, BoneView bone) {
        // TODO
...
//        }
     ...
     * 如果缩放全为 0，则返回 true
     */
    public static boolean scaleMatrixForBone(PoseStack poseStack, BoneView bone) {
        // TODO
...
//        return scaleX == 0 && scaleY == 0 && scaleZ == 0;
    ...
    public static void translateToPivotPoint(PoseStack poseStack, BoneView bone) {
        // TODO
//        poseStack.translate(bone.getPivotX() / 16f, bone.getPivotY() / 16f, bone.getPivotZ() / 16f);
    }

    public static void translateAwayFromPivotPoint(PoseStack poseStack, BoneView bone) {
        // TODO
//        poseStack.translate(-bone.getPivotX() / 16f, -bone.getPivotY() / 16f, -bone.getPivotZ() / 16f);
    }

    public static void translateAndRotateMatrixForBone(PoseStack poseStack, BoneView bone) {
     ...
     * 如果缩放为 0，则返回 true
     */
    public static boolean prepMatrixForBone(PoseStack poseStack, BoneView bone) {
    ...
    public static boolean prepMatrixForLocator(PoseStack poseStack, List<BoneView> locatorHierarchy) {
        ...
        BoneView lastBone = locatorHierarchy.get(locatorHierarchy.size() - 1);
