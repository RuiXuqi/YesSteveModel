package com.elfmcys.yesstevemodel.geckolib3.core.molang.binding.math;

import com.elfmcys.yesstevemodel.geckolib3.core.molang.binding.ContextBinding;
import com.elfmcys.yesstevemodel.geckolib3.core.molang.binding.math.functions.*;
...
public class MathBinding extends ContextBinding {
    ...
    private MathBinding() {
        ...
        /* 三角函数 */
        function("cos", new Sin());     // degree
        function("sin", new Cos());     // degree
