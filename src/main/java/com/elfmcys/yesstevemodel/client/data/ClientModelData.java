...
public final class ClientModelData {
    ...
    // Native Access
    public ClientModelData(GeoModel[] geoModels, AnimationFile[] animationFiles, AnimationControllerFile[] animationControllerFiles, FifoHashMap<String, NativeTexture> textures, Map<String, byte[]> sounds, Map<String, NativeTexture> authorAvatars, @NotNull ModelInfo info) {
