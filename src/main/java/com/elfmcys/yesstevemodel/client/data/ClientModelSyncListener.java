...
public interface ClientModelSyncListener {
     ...
     * 首次进入游戏时此阶段可能要很久
     */
    void onSyncPreparation();

    /**
     * 模型发生重命名或 needAuth 属性改变时触发
     * 每轮同步最多触发一次
     */
    void onAlterModels(Map<String, ClientModel> models);
     ...
     */
    void onSyncProgression(int total, int complete);
     ...
     */
    void onNewModelLoaded(Map<String, ClientModel> models, String newModelId, ClientModel newModel);
     ...
     * msg 为 null 则为未知错误
     */
    void onSyncFailed(@Nullable Component msg);
}
